# buildozer.spec
# This file is used to configure your Kivy Android build.
...
# (string) Presplash background color (for android toolchain) (UNCOMMENTED)
# Supported formats are: #RRGGBB #AARRGGBB or one of the following names:
# red, blue, green, black, white, gray, cyan, magenta, yellow, lightgray,
# darkgray, grey, lightgrey, darkgrey, aqua, fuchsia, lime, maroon, navy,
# olive, purple, silver, teal.
android.presplash_color = #000000 # Set to pure black for sleekness
...
# (list) Permissions (UNCOMMENTED and includes VIBRATE)
